...
Mobile.tap(findTestObject('Driver/Put Online/android.view.ViewGroup5'), 0)

Mobile.tap(findTestObject('Driver/Put Online/android.widget.Switch0 - OFF'), 0)

Mobile.tap(findTestObject('Driver/Put Online/android.widget.TextView6 - Online'), 0)
