...
Mobile.setText(findTestObject('Passenger/Accounts/android.widget.EditText0 - Mobile Number'), '0715645545', 0)

Mobile.setText(findTestObject('Passenger/Accounts/android.widget.EditText1'), 'password123', 0)
