...
Mobile.tap(findTestObject('Driver/Get Road pickup/android.view.ViewGroup19'), 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Driver/Get Road pickup/android.view.ViewGroup13'), 0)
