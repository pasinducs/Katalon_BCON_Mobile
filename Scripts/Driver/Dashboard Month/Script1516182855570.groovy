...
Mobile.tap(findTestObject('Driver/Dashborad/android.view.ViewGroup14'), 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('Driver/Dashborad/android.view.ViewGroup8'), 0)

Mobile.delay(5, FailureHandling.STOP_ON_FAILURE)

Mobile.checkElement(findTestObject('Driver/Dashborad/android.view.ViewGroup5 (1)'), 0)
